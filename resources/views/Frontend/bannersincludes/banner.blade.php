...
.zoom-image:hover,
.zoom-image1:hover {
    transform: translateX(10px) translateY(20px) scale(1.6); /* Reduced scale for 60px base */
    z-index: 10000;
    position: relative;
}

.zoom-left:hover {
    transform: translateX(-20px) translateY(20px) scale(1.6); /* Matches visual intensity */
}
    ...
    <div id="top-ad1" class="top-ad-container1 mx-1 mobile ">
        ...
        <div class="bg-blue text-white p-2 mt-3 position-relative" 
            ...
            <div class="d-flex align-items-center justify-content-between h-100 px-2">
                <!-- Start Image (Left) -->
                <img src="{{ asset('assets/images/logo.png') }}" class="zoom-image" alt="Logo" style="height: 60px; width: auto;">
                
                <!-- End Image (Right) -->
                <img src="{{ asset('assets/images/lo4.png') }}" class="zoom-image zoom-left" alt="Logo" style="height: 60px; width: auto;">
            </div>
        ...
        <div class="d-flex align-items-center mt-1" style="min-height: 80px;">
            ...
            <div class="top-ad-banner1" style="flex-shrink: 0; margin-right: 15px; overflow: visible; position: relative;">
                <img src="{{ asset('storage/app/public/' . $member->image) }}" 
                     alt="{{ $member->name }}" 
                     class="ban zoom-image" 
                     style="height: 102px; margin-left: -10px; margin-top: 10px;" />
            </div>
        
            <!-- Member Name and Role on the Right -->
            <div class="details-container" style="line-height: 1.2;">
                <h2 class="fs-5 mb-1">{{ $member->name }}</h2>
                <p class="fs-6 mb-0"><b>{{ $member->role }}</b></p>
            </div>
        </div>
