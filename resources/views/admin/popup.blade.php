<style>
    .gradient-btn {
        ...
        font-weight: 500;
        transition: none;
        /* remove smooth hover transition */
    }
...
<div class="row">
    ...
    <small style="font-size: 12px;">Note: Ad size should be (800x500)px</small>
</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="max-width: 200px; word-break: break-word; white-space: normal;">
                                    <a href="{{ $banner->link }}" target="_blank" title="{{ $banner->link }}" style="max-width: 100%;">
                                        {{ $banner->link}}
                                    </a>
                                </td>
                                <td class="text-center">
