...
<div class="container mt-4">
    ...
    <div class="col-md-12 d-flex justify-content-center">
        <button type="button" class="btn custom-btn" id="nextToOfficial" style="background: linear-gradient(115deg, #0f0b8c, #77dcf5); border-radius: 5px;">
            Next
        </button>
    </div>
</div>
    ...
    <option value="{{ $chapter->id }}">{{ \Illuminate\Support\Str::title(strtolower($chapter->chapter_name)) }}</option>
@endforeach
    ...
    <input type="text" name="phone_number" class="form-control" id="mobileNumber" maxlength="10" pattern="\d{10}" title="Enter 10-digit number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
</div>
<div class="col-md-3">
    <label class="form-label">Home Number</label>
    <input type="text" name="home_number" class="form-control" id="homeNumber" maxlength="10" pattern="\d{10}" title="Enter 10-digit number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
</div>
<div class="col-md-3">
    <label class="form-label">Work Number</label>
    <input type="text" name="work_number" class="form-control" id="workNumber" maxlength="10" pattern="\d{10}" title="Enter 10-digit number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
</div>
...
<div class="row mt-4" id="submitSection" style="display: none;">
    <div class="col-md-12 text-center">
        <button type="submit" class="btn custom-btn"  style="background: linear-gradient(115deg, #0f0b8c, #77dcf5); border-radius: 5px;">
            Save Member
        </button>
    </div>
</div>
