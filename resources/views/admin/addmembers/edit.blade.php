    ...
    @endif
            ...
            <form class="small-font" action="{{ route('members.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs mb-3" id="memberTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="official-tab" data-bs-toggle="tab" href="#official" role="tab">Official Details</a>
                    </li>
                </ul>
...
<div class="col-md-4">
    ...
    <div class="col-md-4">
        @if($member->profile_photo)
            ...
            <img src="{{ asset('storage/app/public/' . $member->profile_photo) }}" class="mt-2 rounded" width="50" alt="Profile Photo">
        @endif
    </div>
</div>
