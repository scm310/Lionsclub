                                ...
                                <form action="{{ route('events_store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="tel" class="form-control" name="total_volunteers" placeholder="Enter total volunteers" required>
                                        </div>
                ...
                $('#completedEventsTable').DataTable({
                    ...
                    columnDefs: isMobile ? [{
                        ...
                        }, // '+' icon
                        {
                            targets: [0, 1],
                            visible: true
                        }, // Show S.No and Event Name
                        {
                            targets: '_all',
                            visible: true
                        } // All visible; responsive will collapse rest
                    ] : [{
                            targets: 0,
                            visible: false
