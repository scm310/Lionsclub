...
<div class="container mt-4">
        ...
        <div class="overflow-auto">
            <ul class="nav nav-tabs flex-nowrap" id="bannerTabs" role="tablist" style="white-space: nowrap;">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" data-bs-toggle="tab" href="#uploadBanners" role="tab">Upload Top Ad</a>
                </li>
                <li class="nav-item" role="presentation">
                            ...
                            <div class="card-body" style="background-color: #87cefa;">
                                ...
                                <form action="{{ route('upload.banner') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small style="font-size: 12px;">Note: Ad Size Should be ({{ $bannerSizes[$banner] }})px</small>
    ...
    <small style="font-size: 12px;">Note: Ad Size Should be (1353x180)px</small>
</div>
                                    ...
                                    <table class="table table-striped table-bordered dt-responsive nowrap" id="table-image4" style="width: 100%; overflow-x: auto;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fold-url" data-url="{{ $banner->website_link }}">
                                                    <a href="{{ $banner->website_link }}" target="_blank" title="{{ $banner->website_link }}"></a>
                                                </td>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.fold-url').forEach(function(td) {
                ...
                const folded = url.match(/.{1,15}/g).join('<wbr>'); // Insert break every 20 chars
