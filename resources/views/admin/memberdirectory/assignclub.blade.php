...
.white-container {
    ...
    min-height: 100px; /* Optional: just a starting base height */
    height: auto !important; /* This ensures it grows */
    overflow: visible;
}
...
<div class="col-md-8">
    ...
    <!-- Members Table -->
    <table class="table table-bordered rounded shadow-sm" id="membersTable" style="width: 95%;">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <div class="col-md-4">
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn custom-btn w-50">Assign  Member</button>
                </div>
            </div>
        </div>
    </form>
