...
<div class="overflow-auto">
    <ul class="nav nav-tabs flex-nowrap" id="pricingTabs" role="tablist" style="white-space: nowrap;">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="ad1-tab" data-bs-toggle="tab" href="#ad1" role="tab">Advertisement Image 1</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="ad2-tab" data-bs-toggle="tab" href="#ad2" role="tab">Advertisement Image 2</a>
        </li>
    </ul>
</div>
...
<div class="tab-content mt-3">
    ...
    <div class="tab-pane fade show active" id="ad1" role="tabpanel">
        <div class="table-responsive mt-2">
            <table id="Tabler1" class="table table-striped table-bordered dt-responsive nowrap w-100">
    ...
    <!-- Advertisement 2 -->
    <div class="tab-pane fade" id="ad2" role="tabpanel"> <!-- <-- FIXED ID -->
        <div class="table-responsive mt-2">
            <table id="Tabler2" class="table table-striped table-bordered dt-responsive nowrap w-100">
                <thead class="bg-dark text-white text-center text-capitalize">
                    <tr>
                        <th>S.No</th>
                        <th>Banner Images</th>
...
<script>
    ...
    $(document).ready(function () {
        initDataTable('#Tabler1');
        initDataTable('#Tabler2');
