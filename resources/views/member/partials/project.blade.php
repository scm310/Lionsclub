            ...
            <form action="{{ route('project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="file" name="project_image" class="form-control mb-2" style="font-size: 12px;">
                    </div>
                    <div class="col-md-3">
        ...
        <div id="projectFields">
            <div class="row projectRow mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="file" name="project_image[]" class="form-control"  style="font-size: 12px;" required>
                </div>
                <div class="col-md-3">
                    <label>Location</label>
