   ...
   @foreach($clients as $client)
        <form action="{{ route('client.update', $client->id) }}" method="POST" class="mb-3 d-flex align-items-end">
            ...
            <div class="row w-100">
                ...
                <div class="col-md-1">
                    <a href="{{ route('client.delete', $client->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Delete this client?')">Delete</a>
                </div>
            </div>
        </form>
        @endforeach
        ...
        <form action="{{ route('client.store') }}" method="POST">
            ...
            <div id="clientFields">
                <div class="row clientRow mb-3">
                    ...
                    <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger removeClient">X</button></div>
                </div>
            </div>
