...
.month-link {
    position: sticky;
    top: 60px; /* Adjust based on the tab height */
    z-index: 99;
    ...
    font-weight: bold;
    background-image:
        linear-gradient(to right, #000000, #000000), /* Button background */
        linear-gradient(45deg, #00f, #ff0); /* Border gradient */
...
<div class="sticky-header py-3 px-2 text-center"
     style="position: sticky; top: 180px; z-index: 1020; background: #ffffff; padding-top:0px !important;">

    <h3 class="fw-bold text-dark mb-2">Gallery</h3>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-2">
        ...
        @foreach($months as $month)
            <a href="#"
               class="month-link btn btn-outline-primary btn-sm {{ $month === $currentMonth ? 'active' : '' }}"
               data-month="{{ $month }}">
               {{ $month }}
            </a>
        @endforeach
                    ...
                    <div class="card shadow-sm border border-secondary {{ $highlightedImage == $mainImageName ? 'selected-card' : '' }}">
                        ...
                        <div class="card-body p-2 text-center">
                            ...
                            <div class="card-body p-2 text-center">
                                ...
                                <h6 class="fw-bold text-primary mb-2">{{ $eventName }}</h6>
