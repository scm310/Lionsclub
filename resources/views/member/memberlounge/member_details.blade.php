...
.tab-btn {
    padding: 5px 10px; /* smaller vertical padding for reduced height */
    border: none;
    border-radius: 4px;
    color: white;
...
@media (max-width: 480px) {
    ...
    .tab-btn {
        font-size: 11px;
        padding: 6px 10px;
        flex: 1 0 auto; /* allow buttons to shrink */
    }
        ...
        <div class="d-flex align-items-start gap-3 mb-3">
            ...
            <div class="flex-shrink-0">
                <img id="profilePic" src="" alt="Profile Picture"
                     style="width: 100px; height: 100px; object-fit: cover; border-radius: 10px; border: 3px solid white;">
            </div>
        </div>
    </div>
</div>
