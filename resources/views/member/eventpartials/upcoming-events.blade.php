          ...
          @forelse($upcomingEvents as $event)
              ...
              <div class="event-row cards_item col-6 col-lg-6th" data-month="{{ $eventMonth }}"
                  ...
                  <div class="card upcoming-event-card p-3 rounded shadow-sm mb-2 d-flex flex-column justify-content-center align-items-center"
                      ...
                      data-image="{{ asset($imagePath) }}" onclick="showUpcomingEventDetails(this)">
  ...
  <div id="upcomingEventDetails" class="position-fixed top-0 end-0 shadow-lg p-4 d-none"
      style="width: 380px; z-index: 1055; overflow-y: auto;
        ...
        max-height: 80vh;">
      <!-- Added max-height to allow scrolling when content is large -->
      ...
      <div id="upcomingEventInvitationContainer" class="mb-3 text-center">
          <img id="upcomingEventInvitationImage" src="" alt="Event Invitation"
              class="img-fluid rounded shadow-sm" style="width:300px; height:200px; object-fit: fill;">
      </div>

      <!-- Event Details Card -->
      <div class="card text-dark shadow-sm"
          style="background-color:linear-gradient(115deg, #ffffff, #eeeeee, #ffffff); width:97%;">
          <div class="card-body">
