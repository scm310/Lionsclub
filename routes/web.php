...
Route::post('/members/transfer', [MemberController::class, 'transfer'])->name('members.transfer');
...
Route::get('/announcements/{chapterId?}', [MemberController::class, 'showAnnouncements'])->name('member.announcements');
